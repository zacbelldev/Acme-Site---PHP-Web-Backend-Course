                ...
                <section id="main_section_hero">
                    ...
                    <form method="post" action="/acme/reviews/index.php">
                        <fieldset>
                            ...
                            <textarea name="reviewText" id="prodDesc" disabled><?php if (isset($reviewText)) {echo $reviewText;} elseif (isset($revInfo['reviewText'])) {echo $revInfo['reviewText'];} ?></textarea><br><br>
                            
                            <input type="submit" class="submitButton" value="Delete Review"><br><br>
