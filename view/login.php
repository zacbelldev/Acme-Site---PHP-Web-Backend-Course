                ...
                <section id="main_section_hero">
                    ...
                    <form method="post" action="/acme/accounts/index.php">
                        <fieldset>
                            ...
                            <input type="email" name="email" placeholder="Enter your valid email" <?php if(isset($email)){echo "value='$email'";} ?> required><br><br>

                            <label for="password">Client Password:</label>
                            <span>Passwords must be at least 8 characters and contain at least 1 number, 1 capital letter and 1 special character</span>
                            <input type="password" name="password" id="password" required pattern="(?=^.{8,}$)(?=.*\d)(?=.*\W+)(?![.\n])(?=.*[A-Z])(?=.*[a-z]).*$" placeholder="Enter your password"><br>
                            ...
                            <h2>Not a member?</h2>
                            <button type="button" class="registerButton" onclick="location.href = '?action=register'">Register</button>
                        </fieldset>
                    </form>
                </section>
                <!--Child 2.3.3-->                
