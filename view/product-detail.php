            ...
            <main id="article_main">
                ...
                <section id="main_section_hero">               
                    ...
                    if (isset ($reviewForm)){
                        ...
                        echo "<div class='detailChildForm'>Want to add a review? Go ahead and login. <a href='/acme/index.php?action=signin'> | Login Here</a></div>";
                    }
                    if (isset($reviewDisplay)){
                        echo $reviewDisplay;
                    } else {
                        echo "<div class='detailChildReviews'><p>No Reviews Yet..</p></div>";
                    }
                    echo "</div>";
                    ?>
                </section>
